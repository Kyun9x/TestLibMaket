...
//import com.ipos.saler.util.Utilities
//import com.lib.utill.extension.ActivityExt.showToast
...
//            MyApplication.instance.getString(content!!).replace(
//                "#value",
//                FormatNumberUtil.formatPercent(percent!!).replace(
//                    "-",
//                    ""
//                )
//            )
